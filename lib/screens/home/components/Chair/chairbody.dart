...
import 'package:flutterproject/screens/home/components/Chair/chair_card.dart';
import '../categories.dart';
import '../item_card.dart';

class ChairBody extends StatelessWidget {
  @override
      ...
      children: <Widget>[
        ...
        Expanded(
          ...
          child: Expanded(
            ...
            itemBuilder: (context, index) => ChairCard(
              product: chairproducts[index],
            ),
          )),
        )),
      ],
